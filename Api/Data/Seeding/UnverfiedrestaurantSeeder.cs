...
// /// <inheritdoc />
// public class UnverfiedrestaurantSeeder(
...
//         ["ResBurger8.jpg", "ResBurger8.jpg", "sushi8.png", "wege8.png", "woda8.png"];
...
//     {
//         var exampleDocument = await RequireFileUpload("test-AY1.pdf");
//         var verifier = users.CustomerSupportAgent;

//         return new Restaurant
//         {
//             Name = "Unverided' Restaurant",
//             RestaurantType = RestaurantType.Restaurant,
//             Nip = "6667676879",
//             Address = "ul. 124",
//             PostalIndex = "00-001",
//             City = "Warszawa",
//             Location = geometryFactory.CreatePoint(new Coordinate(30.90990467467737, 53.397394571933175)),
...
//             LogoFileName = null!,
//             Logo = await RequireFileUpload("ResLogo12.png"),
//             ProvideDelivery = true,
//             Description = "The second example restaurant",
//             Photos = await RequireRestaurantPhotos("ResInside13.jpg"),
