...
public class BreakingBadRestaurantSeeder
{
    ...
    public async Task SeedAsync()
    {
        ...
        var losPollosRestaurant = new Restaurant
        {
            ...
            LogoFileName = null!,
            Logo = await RequireFileUpload("restaurantboss4.PNG", _gusFring),
        ...
        losPollosRestaurant.Photos = new List<RestaurantPhoto>
        {
            new()
            {
                ...
                Order = 1,
                PhotoFileName = null!,
                Photo = await RequireFileUpload("ResInside8.jpg", _gusFring)
            }
        };
            ...
            new Menu
            {
                ...
                MenuItems = new List<MenuItem>
                {
                    new MenuItem
                    {
                        ...
                        Restaurant = losPollosRestaurant,
                        PhotoFileName = null!,
                        Photo = await RequireFileUpload("kebab.png", _gusFring),
                    ...
                    new MenuItem
                    {
                        ...
                        Restaurant = losPollosRestaurant,
                        PhotoFileName = null!,
                        Photo = await RequireFileUpload("kebab.png", _gusFring), // Ponowne użycie obrazu
                        Ingredients = new List<IngredientMenuItem>
                        {
                            new IngredientMenuItem { Ingredient = ingredients[0], AmountUsed = 200 }, // Chicken
                            new IngredientMenuItem { Ingredient = ingredients[1], AmountUsed = 50 }, // Flour
            ...
            new Menu
            {
                ...
                MenuItems = new List<MenuItem>
                {
                    new MenuItem
                    {
                        ...
                        Restaurant = losPollosRestaurant,
                        PhotoFileName = null!,
                        Photo = await RequireFileUpload("burger.png", _gusFring),
                        Ingredients = new List<IngredientMenuItem>
                        {
                    ...
                    new MenuItem
                    {
                        ...
                        Restaurant = losPollosRestaurant,
                        PhotoFileName = null!,
                        Photo = await RequireFileUpload("burger.png", _gusFring), // Ponowne użycie obrazu
                        Ingredients = new List<IngredientMenuItem>
                        {
                            new IngredientMenuItem { Ingredient = ingredients[9], AmountUsed = 1 }, // Burger Bun
            ...
            new Menu
            {
                ...
                MenuItems = new List<MenuItem>
                {
                    new MenuItem
                    {
                        ...
                        Restaurant = losPollosRestaurant,
                        PhotoFileName = null!,
                        Photo = await RequireFileUpload("ResVegan2.jpg", _gusFring), // Ponowne użycie obrazu
                        Ingredients = new List<IngredientMenuItem>
                        {
                    ...
                    new MenuItem
                    {
                        ...
                        Restaurant = losPollosRestaurant,
                        PhotoFileName = null!,
                        Photo = await RequireFileUpload("ResVegan2.jpg", _gusFring),
                        Ingredients = new List<IngredientMenuItem>
                        {
            ...
            new Menu
            {
                ...
                MenuItems = new List<MenuItem>
                {
                    new MenuItem
                    {
                        ...
                        Restaurant = losPollosRestaurant,
                        PhotoFileName = null!,
                        Photo = await RequireFileUpload("drinki.png", _gusFring) // Ponowne użycie obrazu
                    },
                    new MenuItem
                    {
                        Name = "Iced Tea",
            ...
            new Menu
            {
                ...
                MenuItems = new List<MenuItem>
                {
                    new MenuItem
                    {
                        ...
                        Restaurant = losPollosRestaurant,
                        PhotoFileName = null!,
                        Photo = await RequireFileUpload("drinki.png", _gusFring)
                    },
                    new MenuItem
                    {
                        Name = "House Wine",
